...
# --- ТЕСТ Цены в Telegram Stars (XTR) ---
PRICE_SLOT = 1               # Цена за +1 слот навсегда
PRICE_SPONSOR_7_DAYS = 1     # ОП на 7 дней
PRICE_SPONSOR_30_DAYS = 2   # ОП на 30 дней (выгоднее!)
PRICE_BOOST = 1              # Буст в ТОП (задел на будущее)